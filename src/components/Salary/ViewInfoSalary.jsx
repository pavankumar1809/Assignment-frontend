  ...
  function Contact() {
    return (
      <form>
        ...
        <strong>:</strong>
        <label className='data'>{employee.email!==""?employee.email:"Not Added"}</label>
        <br />
        <br />

        <label>Mobile </label>
        <strong>:</strong>
        <label className='data'>{employee.mobile!==""?employee.mobile:"Not Added"}</label>
        <br />
        <br />

        <label>Branch </label>
        <strong>:</strong>
        <label className='data'>{employee.branch!==""?employee.branch:"Not Added"}</label>
        <br />
        <br />

        <label>Country </label>
        <strong>:</strong>
        <label className='data'>{employee.country!==""?employee.country:"Not Added"}</label>
        <br />
        <br />
      </form>
    );
