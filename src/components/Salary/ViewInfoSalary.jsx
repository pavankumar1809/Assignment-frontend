...
function ViewInfoSalary(props) {
  ...
  function Contact() {
    return (
      ...
      <strong>:</strong>
      <label className='data'>{(employee.email!==""&&employee.email!==null)?employee.email:"Not Added"}</label>
      <br />
      <br />

      <label>Mobile </label>
      <strong>:</strong>
      <label className='data'>{(employee.mobile!==""&&employee.mobile!==null)?employee.mobile:"Not Added"}</label>
      <br />
      <br />

      <label>Branch </label>
      <strong>:</strong>
      <label className='data'>{(employee.branch!==""&&employee.branch!==null)?employee.branch:"Not Added"}</label>
      <br />
      <br />

      <label>Country </label>
      <strong>:</strong>
      <label className='data'>{(employee.country!==""&&employee.country!==null)?employee.country:"Not Added"}</label>
      <br />
      <br />
    </form>
    );
  ...
  function Bank(){
    ...
    <strong>:</strong>
    <label className='data'>{(employee.bank !== "" && employee.bank !== null)? employee.bank : "Not Added"}</label>
    <br />
    <br />

    <label>Account Number </label>
    <strong>:</strong>
    <label className='data'>{(employee.acc_no!=="" && employee.acc_no !== null)?employee.acc_no:"Not Added"}</label>
    <br />
    <br />

    <label>IFSC Code </label>
    <strong>:</strong>
    <label className='data'>{(employee.ifsc!=="" && employee.ifsc !== null)?employee.ifsc:"Not Added"}</label>
    <br />
    <br />
  </form>
    )
