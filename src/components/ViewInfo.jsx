...
function ViewInfo(props) {
  ...
  const {id} = useParams()
  const [employee,setEmployee] = useState(axios.get(`/employees/${id}`).then(res => {
  ...
  function Bank(){
    ...
    <strong>:</strong>
    <label className='data'>{employee.bank}</label>
    <br />
    <br />

    <label>Account Number </label>
    <strong>:</strong>
    <label className='data'>{employee.acc_no}</label>
    <br />
    <br />

    <label>IFSC Code </label>
    <strong>:</strong>
    <label className='data'>{employee.ifsc}</label>
    <br />
    <br />
  </form>
    )
  ...
  return (
    <div>
      ...
      <div className="addemp">
        <form id="form">
          <ul id="progressbar" style={{width:"60%",marginLeft:"25%"}}>
